...
public class Testfriend3 extends AppCompatActivity {
    ...
    public static Context context_testfriend3; // context 변수 선언
    public String var4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_testfriend3);
        context_testfriend3 = this;
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Testfriend3.this, Testfriend4.class);
